...
TGIF takes parameters from the command line and from a configuration file, and constructs an API query to retrieve the feed as requested. The feed is printed to stdout (or to a specified optional file) exactly as received. 
